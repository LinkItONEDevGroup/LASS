...
console.log(gps_lat);
      ...
      tmp = tmp * 60;
      gps_lat = Math.floor(gps_lat) + Math.floor(tmp)*0.01;
      tmp = tmp - Math.floor(tmp);
      tmp = tmp * 60;
      gps_lat = gps_lat + tmp * 0.0001;
console.log(gps_lat);
...
console.log(gps_lon);
      ...
      tmp = tmp * 60;
      gps_lon = Math.floor(gps_lon) + Math.floor(tmp)*0.01;
      tmp = tmp - Math.floor(tmp);
      tmp = tmp * 60;
      gps_lon = gps_lon + tmp * 0.0001;
console.log(gps_lon);
