...
public:
   ...
   boolean publish(char *, uint8_t *, uint16_t);
   boolean publish(char *, uint8_t *, uint16_t, boolean);
  // boolean publish_P(char *, uint8_t PROGMEM *, uint16_t, boolean);
